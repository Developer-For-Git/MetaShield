...
### 1. Multi-Format Metadata Stripping
MetaShield isn't just for photos. We provide comprehensive support across the digital spectrum:
...
### 2. Precision Removal & Custom Injection
...
*   **Custom Metadata Editor:** Sometimes you want to *own* your data. Use our editor to inject your own copyright information or custom tags into your files.
...
### 3. High-Velocity Batch Processing
Efficiency is at our core. Whether you're sharing a single vacation snap or an entire project folder, MetaShield’s multi-threaded processing engine handles hundreds of files in seconds. Each operation is **non-destructive**, ensuring your original files remain untouched while creating "Shielded" copies for sharing.
...
MetaShield operates on a **Zero-Cloud Policy**.
...
*   **Open Progress:** Monitor your batch tasks with real-time notifications and progress tracking.
...
*   **Language:** 100% Kotlin
*   **UI Framework:** Jetpack Compose (MD3)
*   **Asynchrony:** Kotlin Coroutines & Flow
*   **Background Tasks:** WorkManager for reliable batch processing
*   **Architecture:** Clean Architecture with MVVM and Hilt DI
